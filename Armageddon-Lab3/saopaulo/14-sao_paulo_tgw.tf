...
resource "aws_ec2_transit_gateway_peering_attachment_accepter" "liberdade_accept_peer01" {
  provider                     = aws.saopaulo
  transit_gateway_attachment_id = "tgw-attach-081ec6ebd90f109bb"
...
# resource "aws_ec2_transit_gateway_peering_attachment_accepter" "liberdade_accept_peer01" {
#   provider                     = aws.saopaulo
#   transit_gateway_attachment_id = data.terraform_remote_state.tokyo.outputs.shinjuku_to_liberdade_peer_attachment_id
#   tags = { Name = "liberdade-accept-peer01" }
# }
